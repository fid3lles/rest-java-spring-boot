package br.com.fidelles.unittests.mockito.services;
...
import br.com.fidelles.book.service.BookService;
import br.com.fidelles.exception.RequiredObjectIsNullException;
import br.com.fidelles.unittests.MockBook;
...
class BookServiceTest {
	...
	void testFindById() throws Exception {
		...
		assertEquals("Author name 1", result.getAuthor());
		assertEquals(99D, result.getPrice());
	...
	void testFindAll() throws Exception {
		...
		assertEquals("Author name 1", bookOne.getAuthor());
		assertEquals(99D, bookOne.getPrice());
		...
		assertEquals("Author name 4", bookFour.getAuthor());
		assertEquals(99D, bookFour.getPrice());
		...
		assertEquals("Author name 7", bookSeven.getAuthor());
		assertEquals(99D, bookSeven.getPrice());
